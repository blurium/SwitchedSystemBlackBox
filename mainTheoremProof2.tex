...
for some $E'$ where $\sigma_P(E') \leq m \epsilon$.  Then, applying Theorem \ref{thm:mainTheorem1}, we can compute $$\delta(\beta, \omega_N) = \bar{\alpha}(m(1- I^{-1}(\beta; d+1, N-d)))$$ such that with probability at least $\beta$ we have:
\begin{equation*}
