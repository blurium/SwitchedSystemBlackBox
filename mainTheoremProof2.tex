...
for some $E'$ where $\sigma_P(E') \leq m \epsilon$.  Then, applying Theorem \ref{thm:mainTheorem1}, we can compute $$\delta(\beta, \omega_N)= \alpha(\epsilon) = \alpha(I^{-1}(1- \beta; N-d, d+1)),$$ such that with probability at least $\beta$ we have:
\begin{equation*}
