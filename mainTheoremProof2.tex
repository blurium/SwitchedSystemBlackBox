...
for some $E'$ where $\sigma_P(E') \leq m \epsilon$.  Then, applying Theorem \ref{mainTheorem1}, we can compute $\delta(\beta, \omega_N)= \alpha(\epsilon) = 1- I^{-1}(\beta;d+1,N-d)$ such that:
\begin{equation*} 
\end{equation*}
%
