...
\begin{equation}
%(A_{j_l} A_{j_{l-1}} \dots A_{j_1} x)^T (A_{j_l} A_{j_{l-1}} \dots A_{j_1} x) \leq ( \gamma^{*}(1+\eta) )^{2l} x^T x, \, \forall\ x \in \sphere \setminus \sphere', \forall\ (j_1,\dots,j_l) \in M^l,
\end{equation}
