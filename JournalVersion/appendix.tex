...
\begin{equation}\label{eqn:alphaEpsilon}\alpha(\epsilon) = \sqrt{1- I^{-1}\left(\epsilon; \frac{n-1}{2}, \frac{1}{2}\right)}, \end{equation}
...
\begin{equation}\sigma^{n-1}(\calC_{c, k}) = I\left(1-\Delta(\calC_{c,k})^2; \frac{n-1}{2}, \frac{1}{2}\right).
\end{equation}
Since, \mbox{$\sigma^{n-1}(\calC_{c, k})= \epsilon$,} we get the following set of equations:
\begin{eqnarray}\nonumber \epsilon &=& I\left(1- \Delta(\calC_{c,k})^2;\frac{n-1}{2}, \frac{1}{2}\right) \\
\nonumber 1- \Delta(\calC_{c, k})^2 &=&  I^{-1}\left(\epsilon; \frac{n-1}{2}, \frac{1}{2}\right) \\
\label{eqn:last}\Delta(\calC_{c, k})^2 &=&  1- I^{-1}\left(\epsilon; \frac{n-1}{2}, \frac{1}{2}\right).
\end{eqnarray}
