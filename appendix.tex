...
\begin{proof}By Lemma \ref{thm:mainSphericalCap} we know that:
...
\end{eqnarray}
The inequalities \eqref{eqn:last} and \eqref{eqn:sc} imply the inclusion given in \eqref{eqn:ballinc}.
\end{proof}
...
which implies that
$$\rho \leq \frac{\gamma^*}{\alpha(\epsilon)}.$$
