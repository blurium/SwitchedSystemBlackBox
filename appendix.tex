...
where  $\alpha(\epsilon) := I^{-1}\left(\frac{\epsilon'\Gamma(\frac{n}{2})}{\pi^{n/2}}, \frac{n-1}{2}, \frac{1}{2}\right)$, and $$\Gamma(x)=\int_{0}^{\infty} t^{x-1} e^{-t} \text{d}t.$$ Here $I^{-1}$ is the inverse incomplete beta function, i.e.,  $I^{-1}(y; a,b)= x$ where $I(x;a,b)=y$.
\end{theorem}
