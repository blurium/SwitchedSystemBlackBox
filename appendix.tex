...
\end{eqnarray}
The inequalities \eqref{eqn:last} and \eqref{eqn:sc} imply the inclusion given in \eqref{eqn:ballinc}, where \begin{equation}\label{eqn:alphaEpsilon}\alpha(\epsilon) = 1- I^{-1}\left(\frac{\epsilon\Gamma(\frac{d}{2})}{\pi^{d/2}}; \frac{d-1}{2}, \frac{1}{2}\right).\end{equation}
\end{proof}
\end{subsection}
